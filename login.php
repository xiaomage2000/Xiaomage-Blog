...
<div id="background">
    <div id="flame">
        ...
        <div id="main">
            <div id="left">
                <div id="new_post_tittle">登录到 Xiaomage's Blog</div>
                <div id="new_post_flame">
                    ...
                    <form action="./logined.php" method="post">
                        用户名：<input type="text" name="username" style="width:45%;height:20px;" placeholder="请输入用户名"><br>
                        密码：&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="passwords" style="width:45%;height:20px;" placeholder="请输入密码"><br><br>
