...
$edit_id = $_GET["id"];
$sql = "SELECT * FROM xiaomage_blog WHERE id = $edit_id";
...
<div id="background">
    <div id="flame">
        ...
        <div id="main">
            <div id="left">
                <div id="new_post_tittle">编辑此文章</div>
                ...
                <div id="new_post_flame">
                    <form action="./edited.php" method="post">
                        ...
                        标题：<input type="text" name="tittle" style="width:45%;height:20px;" value="<?php echo $data_array['tittle']?>"><br>
                        作者：<input type="text" name="author" style="width:45%;height:20px;" value="<?php echo $data_array['author']?>"><br>
                        文章内容：<br><textarea name="content" style="width:85%;height:320px;"><?php echo $data_array['content']?></textarea><br><br>
