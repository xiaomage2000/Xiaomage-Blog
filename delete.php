            ...
            <div id="main">
                <div id="left">
                    <div id="blog_container">
                        ...
                        <div id="del_content">
                            您确定要删除此文章吗？<br><br>这将导致这篇文章从数据库中<span class="highlight">永久删除</span>，并且删除过程<span
                                class="highlight">不可逆</span>！
                        </div>
                        <div id="blog_options">
                            <div class="blog_option"><a href="./deleted.php?id=<?php echo $del_id?>"><span
                                        class="highlight">&nbsp;&nbsp;确定！&nbsp;</span></a></div>
