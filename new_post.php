...
<body>
    ...
    <div id="background">
        <div id="flame">
            ...
            <div id="main">
                <div id="left">
                    <div id="new_post_title">添加新文章</div>
                    <div id="new_post_flame">
                        <div></div>
                        <form action="./posted.php" method="post">
                            标题：<input type="text" name="title" style="width:45%;height:20px;" placeholder="请输入标题" required><br>
                            <input type="hidden" name="author" value="<?php echo $author?>">
                            <?php echo "作者：$author"; ?><br>
                            文章内容：<br><textarea name="content" style="width:85%;height:320px;"
                                placeholder="在此输入文章内容" required></textarea><br><br>
